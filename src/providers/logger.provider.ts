 ...
 *
 * It lives in this module rather than `helpers/` on purpose. It needs the logger, and
 * `helpers/` is imported by `message.setup.ts`, which the logger reaches through its email
 * destination; putting it there would close a dependency cycle.
 */
