...
export class BrandUpdate1776810689646 implements MigrationInterface {
	name = 'BrandUpdate1776810689646';
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "brand" RENAME COLUMN "type" TO "brand_type"`,
		);
		await queryRunner.query(
			`ALTER TYPE "public"."brand_type_enum" RENAME TO "brand_brand_type_enum"`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE UNIQUE INDEX "IDX_brand_slug" ON "brand" ("slug", "brand_type") `,
		);
		await queryRunner.query(
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TYPE "public"."brand_brand_type_enum" RENAME TO "brand_type_enum"`,
		);
		await queryRunner.query(
			`ALTER TABLE "brand" RENAME COLUMN "brand_type" TO "type"`,
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_article_content_unique_per_lang" ON "article_content" ("article_id", "language") `,
		);
