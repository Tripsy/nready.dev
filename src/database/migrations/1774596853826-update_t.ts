...
export class UpdateT1774596853826 implements MigrationInterface {
	name = 'UpdateT1774596853826';
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "place" RENAME COLUMN "type" TO "place_type"`,
		);
		await queryRunner.query(
			`ALTER TYPE "public"."place_type_enum" RENAME TO "place_place_type_enum"`,
		);
		await queryRunner.query(
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TYPE "public"."place_place_type_enum" RENAME TO "place_type_enum"`,
		);
		await queryRunner.query(
			`ALTER TABLE "place" RENAME COLUMN "place_type" TO "type"`,
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_article_content_unique_per_lang" ON "article_content" ("article_id", "language") `,
		);
